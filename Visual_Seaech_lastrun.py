...
expName = 'Visual_Seaech'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='D:\\lab in psychology\\VISUAL_Search\\Visual_Seaech_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisTrial in trials:
        ...
        if random() > 0.5:
            no_Distractor = 10
            thisExp.addData('no_Distractor', no_Distractor)
        else:
            no_Distractor = 5
            thisExp.addData('no_Distractor', no_Distractor)
